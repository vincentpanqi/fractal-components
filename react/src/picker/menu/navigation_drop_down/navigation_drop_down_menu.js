...
export default class NavigationDropDownMenu extends Component {
  ...
  handleMouseLeave = event => {
    ...
    if (
      event.relatedTarget.className !== "navigation_drop_down_menu__popover"
    ) {
      this.setState({
        open: false
      });
  ...
  render() {
    ...
    return (
      <section
        className="navigation_drop_down_menu__container"
        ref="anchor"
        style={{ display: "flex" }}
      ...
      >
        ...
        {dropdown}
        <Popover
          className="navigation_drop_down_menu__popover"
